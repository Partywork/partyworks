...
import { ConnectFourCellState } from "./types";
...
const Cell: React.FC<{ role: ConnectFourCellState }> = ({ role }) => {
  return (
    <div
      className={classNames(styles.cell, {
        [styles.blueCell]: role === ConnectFourCellState.Blue,
        [styles.redCell]: role === ConnectFourCellState.Red,
      })}
    />
  );
};
        ...
        <div className={styles.playerCard}>
          ...
          <div className={styles.playerInfoCard}>
            ...
            <div className={styles.playerInfoContainer}>
              ...
              <span className={styles.playeInfoRole}>
                <Cell role={player.role as any} />
              </span>
            </div>
          </div>
        </div>
